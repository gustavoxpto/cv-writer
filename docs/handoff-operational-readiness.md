...
`ClaudeRephraser`, never written to disk, the database, or a generated artifact. **Never put it in
a committed file**, and never pass it as an inline command-line argument.
